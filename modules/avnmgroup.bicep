...
resource avnmNetworkGroup 'Microsoft.Network/networkManagers/networkGroups@2024-05-01' = {
...
resource avnmNetworkGroupMemeber 'Microsoft.Network/networkManagers/networkGroups/staticMembers@2024-05-01' = [
  for (vnetid, i) in spokeVNETids: {
